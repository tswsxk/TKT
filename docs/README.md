...
TKT is an extension of [EduKTM](https://github.com/bigdata-ustc/EduKTM), which has more advanced features making the training, evaluating and deployment faster and easier.
